...
import torch
import torch.nn.functional as Fecho
...
def main(args):
    ...
    elif args.dataset in ['ogbn-mag', 'mag240m']: # multi-node-types & multi-edge-types
        tgt_type = 'P'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--root", type=str, default='dataset_path/')
    parser.add_argument("--emb_path", type=str, default='dataset_path/sehgnn')
