...
input_path = "dataset_path/mplp_data/mplp/output"
output_path = "dataset_path/mplp_data/submission"
...
y_pred_valid_all = []
acc_all = []
seeds_name = ["seed0", "seed1", "seed2"]
# for seed_path in g
for seed_ in seeds_name:
    seed_path = os.path.join(input_path, seed_)
    y_pred_v = []
    idx_v = []
